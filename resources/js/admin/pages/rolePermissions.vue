        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="_1adminOverveiw_table_recent _box_shadow _border_radious _mar_b30 _p20">
                    <p class="_title0">Tags <Button @click="addModal=true"><Icon type="md-add" /> Add Role Permission</Button></p>
                ...
                <Modal v-model="showDeleteModal" width="360">
                    ...
                    <div slot="footer">
                        <Button type="error" size="large" long :loading="isDeleing" :disabled="isDeleing" @click="deleteItem" >Delete</Button>
                    </div>
                </Modal>
                <!-- show alert modal -->
